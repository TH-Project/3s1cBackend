...
public class NewsService {
    ...
    @Transactional
    public HashMap<String, Double> findGenderRatioByBref(String Bref) {

        HashMap<String, Double> hashMap = new HashMap<>();
        List<Integer> searchedNewsId = newsRepository.findNewsIdByBrief(Bref);
    ...
    @Transactional
    public HashMap<String, Double> findAgeRatioByBref(String bref) {

        HashMap<String, Double> hashMap = new HashMap<>();
        List<Integer> searchedNewsId = newsRepository.findNewsIdByKeyword(bref);
